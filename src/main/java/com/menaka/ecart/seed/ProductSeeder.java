    ...
    public void run(String... args) throws Exception {
        ...
        if (productRepository.count() == 0) {
            List<Product> demoProducts = List.of(
                    ...
                    new Product(null, "Logitech MX Master 3S", 99.99, "Ergonomic performance mouse", "Accessories", 4.9, "Logitech", 40),
                    new Product(null, "Kindle Paperwhite", 139.99, "Waterproof e-reader", "Tablets", 4.8, "Amazon", 30),
                    new Product(null, "JBL Flip 6", 129.95, "Portable waterproof speaker", "Audio", 4.7, "JBL Store", 20)
            );
